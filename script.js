...
const projectsData = [{
    ...
    media: [{
        type: 'image',
        url: 'https://raw.githubusercontent.com/adarshdivase/ADARSH-PORTFOLIO/main/images/ecommerce1.jpeg'
    }, {
        type: 'image',
        url: 'https://raw.githubusercontent.com/adarshdivase/ADARSH-PORTFOLIO/main/images/ecommerce2.jpeg'
    }],
    ...
    details: ["Constructed a robust sales forecasting model using **Facebook Prophet**, achieving 92% MAPE for quarterly sales predictions and effectively reducing stockouts by 10%.", "Engineered comprehensive data processing pipelines using **Pandas and NumPy**, preparing data for time series forecasting and business intelligence.", "Created interactive and dynamic dashboards using **Plotly Express and Streamlit**, visualizing key e-commerce metrics and forecast performance, leading to a 15% increase in revenue strategy impact and a 5% uplift in overall quarterly sales revenue."],
    ...
    media: [{
        type: 'image',
        url: 'https://raw.githubusercontent.com/adarshdivase/ADARSH-PORTFOLIO/main/images/stocks1.jpeg'
    }, {
        type: 'image',
        url: 'https://raw.githubusercontent.com/adarshdivase/ADARSH-PORTFOLIO/main/images/stocks2.jpeg'
    }],
    ...
    details: ["Engineered a real-time AI-driven algorithmic trading system deployed on **Streamlit**, providing live market data, technical indicators, and automated trade execution, leading to a 5% increase in simulated portfolio returns.", "Developed an enhanced trading strategy combining **MACD, RSI, and Bollinger Bands** for multi-factor signal generation with volume confirmation.", "Implemented robust risk management protocols, including dynamic position sizing based on portfolio risk (2% per trade), and maximum daily loss limits (2%), ensuring capital preservation.", "Integrated with **Alpaca API** for fetching historical and live stock data, enabling real-time bar updates and seamless order submission."],
    ...
    media: [{
        type: 'image',
        url: 'https://raw.githubusercontent.com/adarshdivase/ADARSH-PORTFOLIO/main/images/toolkit.jpeg'
    }, {
        type: 'image',
        url: 'https://raw.githubusercontent.com/adarshdivase/ADARSH-PORTFOLIO/main/images/toolkit1.jpeg'
    }],
    ...
    details: ["Architected and deployed a comprehensive, integrated Multi-Modal AI Toolkit on **Hugging Face Spaces**, integrating 9 state-of-the-art Transformer pipelines for diverse AI capabilities.", "Developed a robust **FastAPI** backend with asynchronous operations and **Pydantic models**, exposed via `/api` endpoints.", "Designed an intuitive **Streamlit** frontend for interactive AI service interaction, API call history, and system status monitoring.", "Implemented Text-to-Speech (TTS) with dynamic speaker embeddings and Speech-to-Text (STT) with automatic audio resampling, enhancing accessibility by 15% for 5,000 daily users.", "Utilized key libraries: FastAPI, Streamlit, Hugging Face Transformers, PyTorch, soundfile, librosa."],
    ...
    media: [{
        type: 'image',
        url: 'https://raw.githubusercontent.com/adarshdivase/ADARSH-PORTFOLIO/main/images/hybrid1.jpeg'
    }, {
        type: 'image',
        url: 'https://raw.githubusercontent.com/adarshdivase/ADARSH-PORTFOLIO/main/images/hybrid2.jpeg'
    }],
    ...
    details: ["Developed and deployed an integrated Hybrid Predictive Maintenance system on **Streamlit**, integrating supervised learning (**LSTM**) and reinforcement learning for optimal maintenance recommendations.", "Engineered an LSTM-based deep learning model using **TensorFlow/Keras** to predict machine health and Remaining Useful Life (RUL) from synthetic time-series data, achieving a 30% improvement in prediction accuracy.", "Designed a comprehensive Streamlit multi-page application with a 'Live Dashboard' for real-time monitoring and a 'Historical Explorer' for data analysis.", "Established a persistent **SQLite database** to log simulation reports, including health metrics and explainability insights (simulated **SHAP/LIME**), reducing operational downtime costs by an estimated 20%, resulting in annual savings of $50,000."],
    ...
    media: [{
        type: 'image',
        url: 'https://raw.githubusercontent.com/adarshdivase/ADARSH-PORTFOLIO/main/images/churn1.jpeg'
    }, {
        type: 'image',
        url: 'https://raw.githubusercontent.com/adarshdivase/ADARSH-PORTFOLIO/main/images/churn2.jpeg'
    }],
    ...
    details: ["Architected and deployed an integrated Customer Churn Prediction system on **Streamlit** with a **FastAPI** backend for model inference.", "Developed a robust churn prediction model (F1-score of 0.87) using advanced ML techniques, identifying 75% of potential churners within 30 days.", "Engineered data preprocessing pipelines with **SMOTE**, increasing model recall for the minority class by 25%.", "Launched a high-performance RESTful API using **FastAPI and Uvicorn**, achieving sub-100ms inference latency and handling up to 500 requests/second."],
...
const skillsData = [{
    ...
    skills: ['Python (NumPy, Pandas)', 'SQL', 'FastAPI', 'Flask', 'Data Structures', 'Algorithms']
}, {
    title: 'Machine Learning',
    skills: ['Scikit-learn', 'XGBoost', 'Random Forests', 'SVMs', 'Regression', 'Classification', 'Clustering', 'Feature Engineering', 'Model Evaluation', 'SMOTE', 'Reinforcement Learning']
}, {
    title: 'Deep Learning',
    skills: ['TensorFlow', 'PyTorch', 'Keras', 'CNNs', 'RNNs (LSTMs, GRUs)', 'Transformers', 'Transfer Learning', 'GANs']
}, {
    title: 'MLOps & Deployment',
    skills: ['Docker', 'Kubernetes (basics)', 'Render', 'Heroku', 'Git', 'Uvicorn', 'RESTful API', 'Microservices', 'CI/CD', 'Model Versioning', 'Monitoring', 'Hugging Face Spaces']
}, {
    title: 'Big Data & Databases',
    skills: ['Hadoop', 'Spark', 'Apache Kafka', 'PostgreSQL', 'MySQL', 'SQLAlchemy', 'MongoDB', 'SQLite3']
}, {
    title: 'Data Visualization & BI',
    skills: ['Plotly', 'Matplotlib', 'Seaborn', 'Dash', 'Tableau (conceptual)', 'Streamlit']
}, {
    title: 'Specialized Tools',
    skills: ['SHAP', 'LIME', 'Prophet', 'Whisper API', 'YOLOv5', 'OpenAI API', 'LLMs (ChatGPT)', 'Financial Modeling', 'Monte Carlo Simulation', 'A/B Testing', 'Alpaca API', 'Technical Indicators (MACD, RSI, Bollinger Bands, SMAs)']
}];
