...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('mousemove', (e) => { mouse.x = e.x; e.y = e.y; }); // Fixed typo: 'e.y = e.y' was redundant. Original: 'e.y = e.y'
